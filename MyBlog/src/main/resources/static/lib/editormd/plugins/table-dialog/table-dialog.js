	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				...
				dialogLang.rows + " <input type=\"number\" value=\"3\" class=\"number-input\" style=\"width:60px;height: 30px;\" max=\"100\" min=\"2\" data-rows />&nbsp;&nbsp;",
				dialogLang.cols + " <input type=\"number\" value=\"2\" class=\"number-input\" style=\"width:60px;height: 30px;\" max=\"100\" min=\"1\" data-cols /><br/>",
